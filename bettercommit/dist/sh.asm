...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     254:	68 90 14 00 00       	push   $0x1490
     259:	6a 02                	push   $0x2
     ...
     2c7:	eb 1b                	jmp    2e4 <main+0x44>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 93 14 00 00       	push   $0x1493
...
// add support for built-ins here. cd is a built-in
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     341:	50                   	push   %eax
     342:	68 9b 14 00 00       	push   $0x149b
     347:	6a 02                	push   $0x2
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 a9 14 00 00       	push   $0x14a9
     3ad:	6a 02                	push   $0x2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 ad 14 00 00       	push   $0x14ad
     ...
     55d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 c8 19 00 00       	push   $0x19c8
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 c8 19 00 00       	push   $0x19c8
     ...
     63c:	50                   	push   %eax
     63d:	68 d0 19 00 00       	push   $0x19d0
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 c8 19 00 00       	push   $0x19c8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c6:	50                   	push   %eax
     6c7:	68 c8 19 00 00       	push   $0x19c8
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 b2 14 00 00       	push   $0x14b2
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 c9 14 00 00       	push   $0x14c9
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 cb 14 00 00       	push   $0x14cb
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 cd 14 00 00       	push   $0x14cd
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 cf 14 00 00       	push   $0x14cf
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 ec 14 00 00       	push   $0x14ec
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 ef 14 00 00       	push   $0x14ef
    ...
    panic("parseblock");
     ...
     9c4:	68 f1 14 00 00       	push   $0x14f1
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 fc 14 00 00       	push   $0x14fc
    ...
    panic("syntax - missing )");
     ...
     a14:	68 fe 14 00 00       	push   $0x14fe
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 ef 14 00 00       	push   $0x14ef
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 c2 14 00 00       	push   $0x14c2
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 11 15 00 00       	push   $0x1511
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 1f 15 00 00       	push   $0x151f
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 24 15 00 00 	mov    0x1524(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1030:	0f b6 80 d8 19 00 00 	movzbl 0x19d8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    116c:	75 25                	jne    1193 <printf+0xff>
          s = "(null)";
    116e:	c7 45 f4 3c 15 00 00 	movl   $0x153c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1234:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    12ff:	a3 6c 1a 00 00       	mov    %eax,0x1a6c
}
    1304:	90                   	nop
    1305:	c9                   	leave  
    1306:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1360:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
}
    1365:	c9                   	leave  
    1366:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    137c:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
    1381:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1384:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1388:	75 23                	jne    13ad <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    138a:	c7 45 f0 64 1a 00 00 	movl   $0x1a64,-0x10(%ebp)
    1391:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1394:	a3 6c 1a 00 00       	mov    %eax,0x1a6c
    1399:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
    139e:	a3 64 1a 00 00       	mov    %eax,0x1a64
    base.s.size = 0;
    13a3:	c7 05 68 1a 00 00 00 	movl   $0x0,0x1a68
    13aa:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1400:	a3 6c 1a 00 00       	mov    %eax,0x1a6c
      return (void*)(p + 1);
    ...
    if(p == freep)
    140d:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
