...
int main (int argc, char* argv[]){
  ...
  22:	6a 01                	push   $0x1
  24:	e8 c8 04 00 00       	call   4f1 <printf>
  ...
  6b:	68 f8 08 00 00       	push   $0x8f8
  70:	6a 01                	push   $0x1
  72:	e8 7a 04 00 00       	call   4f1 <printf>
  ...
  c5:	52                   	push   %edx
  c6:	50                   	push   %eax
  c7:	68 04 09 00 00       	push   $0x904
  cc:	6a 01                	push   $0x1
  ce:	e8 1e 04 00 00       	call   4f1 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48d:	0f b6 80 78 0b 00 00 	movzbl 0xb78(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5c9:	75 25                	jne    5f0 <printf+0xff>
          s = "(null)";
 5cb:	c7 45 f4 1f 09 00 00 	movl   $0x91f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 94 0b 00 00       	mov    0xb94,%eax
...
free(void *ap)
{
 ...
 75c:	a3 94 0b 00 00       	mov    %eax,0xb94
}
 761:	90                   	nop
 762:	c9                   	leave  
 763:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7ba:	83 c4 10             	add    $0x10,%esp
  return freep;
 7bd:	a1 94 0b 00 00       	mov    0xb94,%eax
}
 7c2:	c9                   	leave  
 7c3:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7d6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7d9:	a1 94 0b 00 00       	mov    0xb94,%eax
 7de:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7e1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7e5:	75 23                	jne    80a <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7e7:	c7 45 f0 8c 0b 00 00 	movl   $0xb8c,-0x10(%ebp)
 7ee:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7f1:	a3 94 0b 00 00       	mov    %eax,0xb94
 7f6:	a1 94 0b 00 00       	mov    0xb94,%eax
 7fb:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    base.s.size = 0;
 800:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 807:	00 00 00 
  }
 ...
 85d:	a3 94 0b 00 00       	mov    %eax,0xb94
      return (void*)(p + 1);
 ...
 868:	eb 3b                	jmp    8a5 <malloc+0xe1>
    ...
    if(p == freep)
 86a:	a1 94 0b 00 00       	mov    0xb94,%eax
